...
def train_and_evaluate_single_model(model_name: str, args, train_loader, val_loader, test_loader, timestamp: str,
                                  hidden_sizes=None, dropout_rates=None, num_layers=None):
...
def main():
    ...
    # ==================== 레이어 설정 선택 ====================
    # 아래 중 하나를 활성화하고 나머지는 주석 처리하여 사용
        ...
        if normalized_target == 'all':
            ...
            for model_name in ALL_MODELS:
                ...
                summary = train_and_evaluate_single_model(
                    ...
                    hidden_sizes=hidden_sizes, dropout_rates=dropout_rates, num_layers=num_layers
                )
